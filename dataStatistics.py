...
def dataStatistics(data, statistic):
    """ DATASTATISTICS calculates 1 out of 7 possible statistics for the
    data. """
    ...
    if statistic == "Mean Temperature":  # Average T.
        ...
        result = len(data)
    elif statistic == "Mean Cold Growth rate":  # Average G when T < 20degrees.
        result = np.mean(T[T < 20])
    elif statistic == "Mean Hot Growth rate":  # Average G when T > 50degrees.
